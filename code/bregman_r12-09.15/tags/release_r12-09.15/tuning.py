...
class TuningSystem():
    ...
    ::
        ...
        Usage examples:
          T = TuningSystem()
          print T.EQ # equal-temperament frequency ratios
    ...
    def equal_temperament(self, num_steps=12):
        """
        ::
        ...
        self.pitch_ratios_sharp = [Fraction(k,12) for k in range(num_steps+1)]
        self.pitch_ratios_flat = [Fraction(-12+k,12) for k in range(num_steps)]
        self.pitch_ratios_eq = [2**k for k in self.pitch_ratios_sharp]
